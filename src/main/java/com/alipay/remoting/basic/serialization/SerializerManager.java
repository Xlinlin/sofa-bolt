 ...
 */
package com.alipay.remoting.basic.serialization;

import com.alipay.remoting.basic.codec.ProtocolCodeBasedEncoder;
 ...
 * Codec mainly used to encode bytes or decode bytes according to the protocol format. We can use {@link ProtocolCodeBasedEncoder} or {@link io.netty.handler.codec.LengthFieldBasedFrameDecoder} etc.
 * 
 * @author jiangping
