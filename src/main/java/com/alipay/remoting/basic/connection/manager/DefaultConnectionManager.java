 ...
 */
package com.alipay.remoting.basic.connection.manager;
...
public class DefaultConnectionManager implements ConnectionManager, ConnectionHeartbeatManager,
    ...
    /**
     * @see ConnectionManager#add(Connection)
     */
    @Override
    ...
    /**
     * @see ConnectionManager#add(Connection, java.lang.String)
     */
    @Override
    ...
    /**
     * @see ConnectionManager#getAll(java.lang.String)
     */
    @Override
    ...
    /**
     * @see ConnectionManager#remove(Connection)
     */
    @Override
    ...
    /**
     * @see ConnectionManager#remove(Connection, java.lang.String)
     */
    @Override
    ...
    /**
     * @see ConnectionManager#remove(java.lang.String)
     */
    @Override
    ...
    /**
     * @see ConnectionManager#count(java.lang.String)
     */
    @Override
    ...
    /**
     * @see ConnectionManager#create(com.alipay.remoting.Url)
     */
    @Override
    ...
    /**
     * @see ConnectionManager#create(java.lang.String, int, int)
     */
    @Override
    ...
    /**
     * @see ConnectionManager#create(java.lang.String, int)
     */
    @Override
    ...
    /**
     * @see ConnectionHeartbeatManager#disableHeartbeat(Connection)
     */
    @Override
    ...
    /**
     * @see ConnectionHeartbeatManager#enableHeartbeat(Connection)
     */
    @Override
